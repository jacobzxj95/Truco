...
// used to compile shaders for Vulkan /change this
#include "shaderc/shaderc.h" // needed for compiling shaders at runtime change too d3d
#ifdef _WIN32 // must use MT platform DLL libraries on windows
	#pragma comment(lib, "shaderc_combined.lib") //d3d change
#endif