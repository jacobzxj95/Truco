...
namespace AVT 
{
	class PlayerLogic 
	{
		...
		Level_Data* data;
		GW::MATH::GMatrix proxyM;
		std::string playerName = "Leela.001_Cube.h2b";
		std::string bulletName = "Bullet_Sphere.h2b";
		int playerIndex = 0;
		int bulletIndex = 0;
		int bulletStart = 0;
		int bulletEnd = 0;
		int currentBullet = 0;
		GW::MATH::GVECTORF stdVelocity = { 0, 0, -1, 0 };
		bool bulletsOut[100];
		int perFrame = 1;
		bool once = false;
		float devInput;
	...
	private:
		...
		bool FireLasers(flecs::world& stage, AVT::Position origin, AVT::Orientation, AVT::Velocity);
	};
