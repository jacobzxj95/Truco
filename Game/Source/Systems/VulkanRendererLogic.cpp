...
//
//bool AVT::VulkanRendererLogic::Init(	std::shared_ptr<flecs::world> _game, 
...
//}
//
//bool AVT::VulkanRendererLogic::Activate(bool runSystem)
//{
...
//}
//
//bool AVT::VulkanRendererLogic::Shutdown()
//{
//	startDraw.destruct();
//	updateDraw.destruct();
...
//}
//
//std::string AVT::VulkanRendererLogic::ShaderAsString(const char* shaderFilePath)
//{
//	std::string output;
...
//}
//
//bool AVT::VulkanRendererLogic::LoadShaders()
//{
...
//}
//
//bool AVT::VulkanRendererLogic::LoadUniforms()
//{
//	VkDevice device = nullptr;
...
//}
//
//bool AVT::VulkanRendererLogic::LoadGeometry()
//{
//	VkDevice device = nullptr;
//	VkPhysicalDevice physicalDevice = nullptr;
//	vulkan.GetDevice((void**)&device);
...
//}
//
//bool AVT::VulkanRendererLogic::SetupPipeline()
//{
//	VkDevice device = nullptr;
//	vulkan.GetDevice((void**)&device);
...
//}
//
//bool AVT::VulkanRendererLogic::SetupDrawcalls() // I SCREWED THIS UP MAKES SO MUCH SENSE NOW
//{
...
//}
//
//bool AVT::VulkanRendererLogic::FreeVulkanResources()
//{
//	VkDevice device = nullptr;
//	vulkan.GetDevice((void**)&device);
