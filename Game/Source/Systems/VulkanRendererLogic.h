...
namespace ESG
{
	class VulkanRendererLogic
	{
		...
		//Going to delete all of this and replace it with
		//The far superior DX11 variables
	...
	public:
		...
		//Replace all Vulkan References for DX11
		//Add in Render functions and room change functions
	...
	private:
		...
		//Replaced with DX11 Pipeline Logic
		bool LoadShaders();
		bool LoadUniforms();
		bool LoadGeometry();
		bool SetupPipeline();
	...
	private:
		...
		//Will Be Replaced with all Buffer Creation and Definitions
